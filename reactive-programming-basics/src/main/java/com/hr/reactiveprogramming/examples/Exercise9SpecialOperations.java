...
public class Exercise9SpecialOperations {
...
//        ReactiveSources.intNumbersFlux().collectList().subscribe(System.out::println);
        ...
        // Transform to a sequence of sums of adjacent two numbers e.g. 1 - 10 will result in 3 (1+2), 7 (3+4), 11 (5+6) etc.
        // NOTE: buffer takes the given number of elements / events into action and makes a list
